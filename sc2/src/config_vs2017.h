...
* systems when building using a modern version of Visual Studio >= Visual Studio 2017.
* For the config file for older version of visual studio see config_vc6.
*
...
#ifndef _CONFIG_VS2017_H
#define _CONFIG_VS2017_H
