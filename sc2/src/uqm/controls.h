...
typedef struct textentry_state
{
	...
	UQM_UTF8_T *CacheStr; // cached copy to revert immediate changes
	...
	int JoyRegLength;
	UQM_UTF8_T *InsPt;        // set to current pos of insertion point
	// these are public and must be set before calling DoTextEntry
	UQM_UTF8_T *BaseStr;  // set to string to edit
