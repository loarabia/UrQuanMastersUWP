...
LOCDATA CommData;
UQM_UTF8_T shared_phrase_buf[2048];
...
static const UQM_UTF8_T *last_subtitle;
...
static void
FeedbackPlayerPhrase (UQM_UTF8_T *pStr)
{
	SetContext (SpaceContext);
