...
static BOOLEAN
DrawNameString (bool nameCaptain, UQM_UTF8_T *Str, COUNT CursorPos,
		COUNT state)
{
	RECT r;
	TEXT lf;
...
static BOOLEAN
DrawSaveNameString (UQM_UTF8_T *Str, COUNT CursorPos, COUNT state, COUNT gameIndex)
{
	RECT r;
	TEXT lf;
	Color BackGround, ForeGround;
	FONT Font;
	UQM_UTF8_T fullStr[256], dateStr[80];
...
static BOOLEAN
NameSaveGame (COUNT gameIndex, UQM_UTF8_T *buf)
{
	TEXTENTRY_STATE tes;
